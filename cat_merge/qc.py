...
def get_empty(x: Union[List, Dict]) -> Union[List, Dict, None]:
    ...
    match x:
        ...
        case _:
            ...
            # TODO: add message to NotImplemntedError
...
def compare_yaml(a_yaml: Dict, b_yaml: Dict) -> Dict:
    yaml_qc_compare = {}
...
def qc_compare(qc_file_a: str, qc_file_b: str):
    # with open(qc_file_a, "r") as yml_file:
    #     qc_yaml_a = load(yml_file, Loader=get_qc_yaml_loader())
    with open(qc_file_a, "r") as yml_file:
